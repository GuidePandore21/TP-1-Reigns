...
public class Reigns {
    ...
    static void initBanqueQuestions(){
        ...
        Question question1 = new Question(
                ...
                "Oui",
                "Non");
        question1.ajouteEffet(TypeJauge.ARMEE, -5);
        question1.ajouteEffet(TypeJauge.PEUPLE, +5);
        question1.ajouteEffet(TypeJauge.PEUPLE, -7);
        ...
        Question question2 = new Question(
                ...
                "Ne rien faire");
        question2.ajouteEffet(TypeJauge.FINANCE,-5);
        question2.ajouteEffet(TypeJauge.PEUPLE, +5);
        question2.ajouteEffet(TypeJauge.PEUPLE, -5);
        ...
        Question question3 = new Question(
                ...
                "Faire un sacrifice",
                "Ne rien faire");
        question3.ajouteEffet(TypeJauge.CLERGE, +5);
        question3.ajouteEffet(TypeJauge.PEUPLE, -3);
        question3.ajouteEffet(TypeJauge.CLERGE, -5);
        ...
        Question question4 = new Question(
                ...
                "Le soutenir",
                "Rester neutre");
        question4.ajouteEffet(TypeJauge.ARMEE, +3);
        question4.ajouteEffet(TypeJauge.FINANCE, -3);
        question4.ajouteEffet(TypeJauge.CLERGE, -3);
        question4.ajouteEffet(TypeJauge.PEUPLE, +3);
        ...
        question5.ajouteEffet(TypeJauge.FINANCE, +10);
        question5.ajouteEffet(TypeJauge.PEUPLE, -5);
        question5.ajouteEffet(TypeJauge.FINANCE, +1);
        question5.ajouteEffet(TypeJauge.PEUPLE, -3);
